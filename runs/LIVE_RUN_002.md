# LIVE_RUN_002 — SUBJECT_B (18k-LOC agent memory system)
...
**Target:** `SUBJECT_B` — a real, self-improving agent memory system (~18,300 LOC Python):
...
**Fix (shipped):** `patches_SUBJECT_B/01_graph_signal_batch.md` — a `fragments_linked_to_entities`
